...
public record CreateExamRequest(
        ...
        @NotBlank(message = "Loại đề thi không được để trống")
        String examType,
        ...
        @NotNull(message = "Danh sách phần thi không được để trống")
        @Size(min = 1, message = "Phải có ít nhất một phần thi")
        @Valid
        List<ExamSectionRequest> sections
) {
